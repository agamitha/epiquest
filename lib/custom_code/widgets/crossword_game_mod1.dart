...
const Map<String, String> _cwAnswers = {
  ...
  '14,10': 'C', '14,11': 'A', '14,12': 'L', '14,13': 'L', '14,14': 'B',
  '14,15': 'I',
...
const List<Map<String, dynamic>> _cwAcross = [
  ...
  {
    'num': 6,
    'clue': 'A third variable linked to both exposure and disease (11)'
  },
...
const List<Map<String, dynamic>> _cwDown = [
  {
    'num': 1,
    'clue': 'Bias named after a statistician, due to hospital admission (7)'
  },
        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              child:
                  const Icon(Icons.lightbulb_rounded, size: 16, color: _cwBlue),
            ),
