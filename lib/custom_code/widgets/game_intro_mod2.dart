...
class GameIntroMod2 extends StatefulWidget {
  const GameIntroMod2({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  State<GameIntroMod2> createState() => _GameIntroMod2State();
}

const int _kPassM2 = 80;

class _GameIntroMod2State extends State<GameIntroMod2> {
  bool _isPlayed(int? score) => (score ?? 0) > 0;
  bool _isPassed(int? score) => (score ?? 0) >= _kPassM2;
