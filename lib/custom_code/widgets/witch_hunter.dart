...
class _WitchHunterState extends State<WitchHunter>
    with TickerProviderStateMixin {
  final List<Map<String, dynamic>> allStatements = [
    {
      "text":
          "In a cohort study, selecting diseased individuals at baseline is acceptable.",
      "isCorrect": false,
      "explanation":
          "Wrong! Cohort participants must be DISEASE-FREE at baseline!"
    },
    {
      "text": "Loss to follow-up has no effect on validity.",
      "isCorrect": false,
      "explanation": "Wrong! Loss to follow-up causes selection bias!"
    },
    {
      "text": "Cohorts cannot calculate incidence.",
      "isCorrect": false,
      "explanation":
          "Wrong! Calculating incidence is a KEY advantage of cohort studies!"
    },
    {
      "text": "Retrospective cohort = case-control study.",
      "isCorrect": false,
      "explanation":
          "Wrong! They are different — retrospective cohort still starts with exposure!"
    },
    {
      "text": "Incidence can be calculated using prevalent cases.",
      "isCorrect": false,
      "explanation":
          "Wrong! Incidence uses NEW (incident) cases, not prevalent ones!"
    },
    {
      "text": "Cohorts start with exposure measurement.",
      "isCorrect": true,
      "explanation":
          "Correct! Cohort studies begin with identifying exposed vs unexposed groups!"
    },
    {
      "text": "Retrospective cohorts use past records.",
      "isCorrect": true,
      "explanation": "Correct! Retrospective cohorts rely on historical data!"
    },
    {
      "text": "RR is the key measure of association in cohort studies.",
      "isCorrect": true,
      "explanation":
          "Correct! Relative Risk (RR) is directly calculated in cohort studies!"
    },
    {
      "text": "Confounding can distort the exposure–disease relationship.",
      "isCorrect": true,
      "explanation":
          "Correct! Confounders are linked to both exposure and disease!"
    },
    {
      "text": "Follow-up is essential to measure new cases.",
      "isCorrect": true,
      "explanation": "Correct! Without follow-up, you cannot measure incidence!"
    },
  ];
  ...
  void initState() {
    ...
    _witchController = AnimationController(
  ...
  void _handleTap() {
    ...
    _processAnswer(!statements[currentIndex]["isCorrect"],
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Text('Correct: $correctActions / 10',
            style: const TextStyle(
                color: _whBlue, fontWeight: FontWeight.w700, fontSize: 13)),
        Text('Witch HP: $witchHP/10',
            style: const TextStyle(color: _whTextMid, fontSize: 12)),
        Container(
            padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 3),
            decoration: BoxDecoration(
                color: _whBlue, borderRadius: BorderRadius.circular(20)),
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        Container(
            ...
            child: Row(children: [
              AnimatedBuilder(
                  animation: _witchAnimation,
                  builder: (_, __) => Transform.translate(
                      offset: Offset(
                          _witchAnimation.value % 2 == 0
                              ? _witchAnimation.value
                              : -_witchAnimation.value,
                          0),
                    ...
                    ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                            ...
                            valueColor: AlwaysStoppedAnimation(
                                witchHP > 5 ? _whRed : Colors.orange),
                            minHeight: 12)),
                    const SizedBox(height: 4),
                    Text('$witchHP / 10 HP remaining',
                        style:
                            const TextStyle(fontSize: 11, color: _whTextMid)),
                  ])),
            ])),
        ...
        Container(
            ...
            decoration: BoxDecoration(
                color: _whBlueLight, borderRadius: BorderRadius.circular(12)),
            child: const Row(children: [
              Icon(Icons.info_outline_rounded, color: _whBlue, size: 18),
              SizedBox(width: 10),
              Expanded(
                  child: Text(
                      'Tap ❌ to destroy wrong statements  •  Swipe 👉 or tap ✅ to keep correct ones',
                      style: TextStyle(
                          fontSize: 12,
                          color: _whBlue,
        ...
        Wrap(
            ...
            children: List.generate(
                ...
                (i) => Padding(
                    ...
                    child: Text(i < correctActions ? "⭐" : "☆",
                        style: const TextStyle(fontSize: 18))))),
        const SizedBox(height: 8),
        GestureDetector(
          onHorizontalDragUpdate: (d) {
            if (!showFeedback) setState(() => _dragX += d.delta.dx);
          },
          ...
          child: Transform.translate(
              ...
              child: Transform.rotate(
                  ...
                  child: Container(
                      ...
                      child: Column(children: [
                        Text(
                            "📜 Statement ${currentIndex + 1} / ${statements.length}",
                            style: const TextStyle(
                                fontSize: 12, color: _whTextMid)),
                        ...
                        if (_dragX > 30)
                          ...
                          Text("← WRONG DIRECTION",
                              style: TextStyle(color: _whRed, fontSize: 14))
                        else
                          const Text(
                              "Swipe right to keep → or Tap ❌ to destroy",
                              style:
                                  TextStyle(color: _whTextMid, fontSize: 11)),
                      ])))),
        ),
        const SizedBox(height: 12),
        Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          GestureDetector(
              onTap: showFeedback ? null : _handleTap,
              child: Container(
                  width: 130,
                  height: 60,
                  decoration: BoxDecoration(
                      color:
                          showFeedback ? const Color(0xFFD8D8D8) : _whRedLight,
                      borderRadius: BorderRadius.circular(14),
                      border: Border.all(color: _whRed, width: 1.5)),
                  child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        const Text("❌", style: TextStyle(fontSize: 26)),
                        const Text("TAP — Wrong!",
                            style: TextStyle(
                                color: _whRed,
                                fontSize: 11,
                                fontWeight: FontWeight.bold)),
          ...
          GestureDetector(
              onTap: showFeedback ? null : _handleSwipe,
              child: Container(
                  width: 130,
                  height: 60,
                  decoration: BoxDecoration(
                      color: showFeedback
                          ...
                          : _whGreenLight,
                      borderRadius: BorderRadius.circular(14),
                      border: Border.all(color: _whGreen, width: 1.5)),
                  child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        const Text("✅", style: TextStyle(fontSize: 26)),
                        const Text("SWIPE — Correct!",
                            style: TextStyle(
                                color: _whGreen,
                                fontSize: 11,
                                fontWeight: FontWeight.bold)),
        ...
        if (showFeedback)
          AnimatedContainer(
              ...
              decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(color: feedbackCorrect ? _whGreen : _whRed)),
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Image.network(
            ...
            errorBuilder: (_, __, ___) => const Icon(Icons.emoji_events_rounded,
                size: 80, color: _whBlue)),
        const SizedBox(height: 20),
        const Text('Witch Defeated! 💨',
            style: TextStyle(
                fontSize: 26, fontWeight: FontWeight.w800, color: _whBlue)),
        const SizedBox(height: 8),
        const Text('She disappeared into smoke! 🎉',
            style: TextStyle(fontSize: 14, color: _whTextMid)),
        const SizedBox(height: 20),
        Container(
            padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 16),
            decoration: BoxDecoration(
                color: _whBlueLight, borderRadius: BorderRadius.circular(16)),
            child: const Column(children: [
              Text('10 / 10 correct actions',
                  style: TextStyle(fontSize: 14, color: _whTextMid)),
              SizedBox(height: 4),
              Text('100%',
                  style: TextStyle(
        ...
        GestureDetector(
            ...
            child: Container(
                ...
                child: const Text('Next Game: Crossword Puzzle',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.w800,
