...
class _GameCompletionMod1State extends State<GameCompletionMod1>
  ...
  void initState() {
    ...
    // Only build particles and launch confetti if the user actually passed
    if (_passed) {
      _buildParticles();
      ...
      child: Stack(children: [
        ...
        SingleChildScrollView(
          child: Column(children: [
            // -- Header - text changes based on pass/fail --------------
            Container(
              ...
              child: Text(
                _passed ? 'Module 1 Completed!' : 'Module 1 Results',
            ...
            Padding(
              ...
              child: Column(children: [
                ...
                // -- Title - only "Congratulations" if passed ----------
                Text(
                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    if (_passed)
                      const Text(
                        'Score $_gcPass% or above to unlock Module 2  ',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            fontSize: 13,
                      ...
                      Text(
                        'You need $_gcPass% or above to unlock Module 2.\nRetry the games to improve your score.',
                        textAlign: TextAlign.center,
                        style: const TextStyle(
                            fontSize: 12,
        ...
        // -- Confetti - only shown when passed -------------------------
