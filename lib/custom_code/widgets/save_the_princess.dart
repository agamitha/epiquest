...
class _SaveThePrincessState extends State<SaveThePrincess>
  ...
  final List<Map<String, dynamic>> _rawGates = [
    {
      "title": "Gate 1",
      "topic": "Basics of Cohort Studies",
      ...
      "questions": [
        {
          ...
          "answer": 1,
          "clue":
              "Remember: COHORT = Cause → Outcome. You start with people who have or don't have the EXPOSURE, then follow them forward."
        },
        {
          ...
          "answer": 2,
          "clue":
              "If participants already have the disease at the start, you cannot watch it DEVELOP over time — so they must be disease-free at baseline."
        },
        {
          ...
          "options": [
            ...
            "Sideways",
            "Only through historical data"
          ],
          "answer": 1,
          "clue":
              "Cohort studies start with exposure and then WAIT to see who develops the disease. Which direction does that represent in time?"
        },
      ]
    },
    {
      "title": "Gate 2",
      "topic": "Types of Cohorts",
      ...
      "questions": [
        {
          ...
          "options": [
            ...
            "Exposure is measured now, outcome happens later",
            "Only secondary data used",
            "It's faster than retrospective"
          ],
          "answer": 1,
          "clue":
              "'Prospective' = looking ahead. The study starts NOW and follows participants into the FUTURE to see who gets the disease."
        },
        {
          ...
          "options": [
            "Only interviews",
            "Future records",
            "Historical data where exposure and outcome already occurred",
            "Randomized data"
          ],
          "answer": 2,
          "clue":
              "'Retrospective' = looking back. Both exposure and outcome have already happened — the researcher uses PAST records to trace the cohort forward."
        },
        {
          ...
          "answer": 1,
          "clue":
              "'Ambi' means BOTH (like ambidextrous = both hands). An ambispective cohort combines looking backward AND looking forward."
        },
      ]
    },
    {
      "title": "Gate 3",
      "topic": "Steps in Cohort Studies",
      ...
      "questions": [
        {
          ...
          "answer": 2,
          "clue":
              "The whole point is to WATCH who gets the disease over time. Participants must be free of the disease at the START — otherwise you can't observe it developing."
        },
        {
          ...
          "answer": 1,
          "clue":
              "If too many people drop out, your results become unreliable. You need to KEEP loss very small. Which threshold ensures the study remains valid?"
        },
        {
          ...
          "options": [
            "Case groups",
            "Matched controls",
            "Internal or external cohorts",
            "Neighborhood samples only"
          ],
          "answer": 2,
          "clue":
              "In a cohort study you compare EXPOSED vs UNEXPOSED — not cases vs controls. The unexposed group can be from the same study (internal) or a separate group (external)."
        },
      ]
    },
    {
      "title": "Gate 4",
      "topic": "Measures of Risk",
      ...
      "questions": [
        {
          ...
          "answer": 2,
          "clue":
              "RR compares the RATE of NEW disease in exposed vs unexposed groups. Which measure specifically captures the rate of new cases appearing over time?"
        },
        {
          ...
          "answer": 1,
          "clue":
              "RR = 1 means no difference. RR > 1 means MORE disease in exposed. So RR < 1 means LESS disease in the exposed group — what does that make the exposure?"
        },
        {
          "q": "Gate riddle: Attributable Risk (AR) =",
          "options": [
            "Incidence ratio",
            "Incidence among exposed minus Incidence among unexposed",
            "Prevalence difference",
            "Causal score"
          ],
          "answer": 1,
          "clue":
              "AR measures the EXTRA risk due to the exposure. You isolate the exposure's contribution by subtracting the unexposed rate from the exposed rate."
        },
      ]
    },
    {
      "title": "Gate 5",
      "topic": "Bias & Advantages",
      "hint":
      ...
      "questions": [
        {
          ...
          "answer": 1,
          "clue":
              "When people drop out unevenly (e.g. sicker people leave more), the remaining group is NO LONGER REPRESENTATIVE of the original cohort. Which bias is about WHO ends up in your study?"
        },
        {
          ...
          "answer": 1,
          "clue":
              "Because cohort studies start with exposure and follow people forward, they can prove WHICH CAME FIRST — the exposure or the disease. What is this temporal principle called?"
        },
        {
          "q":
              "Final riddle: Which measure can cohort studies directly calculate?",
          "options": [
            "Odds Ratio",
            "Relative Risk",
            "Prevalence Ratio",
          ...
          "answer": 1,
          "clue":
              "Since cohort studies measure incidence in both exposed and unexposed groups, you can directly calculate the measure by dividing incidence in exposed by incidence in unexposed."
        },
      ]
    },
  ];
          ...
          child: Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              const Text(
                  ...
                  textAlign: TextAlign.center,
                  style:
                      TextStyle(fontSize: 13, color: _spTextMid, height: 1.5)),
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  padding: const EdgeInsets.symmetric(vertical: 13),
                  decoration: BoxDecoration(
                      color: _spRed, borderRadius: BorderRadius.circular(14)),
                  child: const Text('Go to Games Menu',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          color: Colors.white,
    ...
    return Container(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Text('Gate ${currentGate + 1} / 5',
            style: const TextStyle(
                color: _spBlue, fontWeight: FontWeight.w700, fontSize: 13)),
        ...
        Container(
          ...
          decoration: BoxDecoration(
              color: _spBlue, borderRadius: BorderRadius.circular(20)),
          child: Text('$_pct%',
              style: const TextStyle(
                  color: Colors.white,
                  fontWeight: FontWeight.w700,
      ...
      child: Column(children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(
                colors: [Color(0xFF1565C0), _spBlue],
          ...
          child: Column(children: [
            ...
            const SizedBox(height: 8),
            const Text(
                'A wicked spell has locked the princess inside a castle protected by 5 magical gates.',
                textAlign: TextAlign.center,
                style:
        ...
        Container(
          ...
          child:
            ...
            _introStep(
                '2',
                'Each gate has 3 questions about Cohort Studies. Answer at least 2 correctly.',
                Icons.quiz_rounded,
                _spBlue),
            _introStep(
                '3',
        ...
        Container(
          ...
          child: Column(children: [
            const Text('Your Mistake Budget',
                style: TextStyle(
                    fontSize: 13, fontWeight: FontWeight.w800, color: _spRed)),
            const SizedBox(height: 10),
        ...
        Container(
          ...
          child: Column(children: [
            const Text('The 5 Gates',
                style: TextStyle(
                    fontSize: 14, fontWeight: FontWeight.w700, color: _spBlue)),
                  ...
                  return Column(children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                                color: _spBlue.withOpacity(0.3), blurRadius: 6)
                          ]),
                      child: Center(
                          child: Text('${i + 1}',
                              style: const TextStyle(
    ...
    return Padding(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Expanded(
            child: Text(text,
                style: const TextStyle(
                    fontSize: 13, color: _spTextMid, height: 1.5))),
      ]),
    );
  }
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: [
                _spBlueDark.withOpacity(0.08),
                _spBlue.withOpacity(0.12)
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text(
                    currentGate == 0
                        ...
                        : currentGate == 1
                            ? 'Gate 1 open! She can sense you coming!'
                            : currentGate == 2
                                ? 'Halfway there! She can hear your footsteps!'
                                : currentGate == 3
                                    ? 'Almost there! One last gate!'
                      ...
                      Stack(alignment: Alignment.center, children: [
                        ...
                        Positioned(
                            ...
                            child: AnimatedBuilder(
                                ...
                                builder: (_, __) => Transform.translate(
                                    offset: Offset(
                                        0, _princessBounceAnim.value * 0.5),
                                    child: const Text('👸',
          ...
          child: Row(children: [
            ...
            Expanded(
                child: Text(gate["hint"],
                    style: TextStyle(
                        fontSize: 12,
                        color: _spAmber.withOpacity(0.9),
                        fontWeight: FontWeight.w600,
                        height: 1.4))),
          ]),
        ),
                ...
                child: Row(children: [
                  ...
                  if (_correctChosen == i)
                    const Icon(Icons.check_circle_rounded,
                        color: _spGreen, size: 20),
                  if (_wrongChosen == i)
                    const Icon(Icons.cancel_rounded, color: _spRed, size: 20),
                ]),
              ),
            ),
          );
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(
                  child: Column(
                    ...
                    Text(_hintText,
                        style: const TextStyle(
                            fontSize: 13, color: _spTextDark, height: 1.4)),
                  ])),
            ]),
          ),
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Container(
          ...
          child: Column(children: [
            ...
            Text(
                ...
                style: TextStyle(
                    fontSize: 12,
                    color: passed ? _spGreen : const Color(0xFFE65100))),
          ]),
        ),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: const Text('Next Game: Witch Hunter',
                textAlign: TextAlign.center,
                style: TextStyle(
                    color: Colors.white,
                    fontWeight: FontWeight.w800,
