...
class _DragDropState extends State<DragDrop> {
  ...
  final List<String> _correctSeq = [
    'Select Cases', 'Select Controls', 'Matching',
    'Measure Exposure', 'Analyze & Interpret',
  ];
  List<String?> _seqSlots = [null, null, null, null, null];
  final List<String> _seqCards = [
    'Matching', 'Select Cases', 'Analyze & Interpret',
    'Measure Exposure', 'Select Controls',
  ];
  ...
  void _checkAndSubmitSeq() {
    _seqAttempts++;
    _seqChecked = true;
    final allCorrect = List.generate(5, (i) => _seqSlots[i] == _correctSeq[i]).every((v) => v);
  ...
  void _nextSet() {
    ...
    if (_currentSet >= 3) {
      final score = _totalItems == 0 ? 0 : ((_totalCorrect / _totalItems) * 100).round();
  ...
  Widget _card(String label) {
    return Draggable<String>(
      ...
      feedback: Material(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              color: _ddBlue, borderRadius: BorderRadius.circular(10),
              boxShadow: const [BoxShadow(color: Color(0x334A90D9), blurRadius: 8)]),
      ...
      childWhenDragging: Container(
        ...
        decoration: BoxDecoration(color: _ddDivider, borderRadius: BorderRadius.circular(10)),
        child: Text(label, style: const TextStyle(fontSize: 13, color: Colors.transparent)),
      ),
      child: Container(
        padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 10),
        margin: const EdgeInsets.all(4),
        decoration: BoxDecoration(
          color: _ddBlueLight, borderRadius: BorderRadius.circular(10),
          border: Border.all(color: _ddBlue, width: 1.5),
        ),
        child: Text(label, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: _ddBlue)),
      ),
    );
  }
  ...
  Widget _setHeader(String badge, String title, String subtitle) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
        ...
        decoration: BoxDecoration(color: _ddBlue, borderRadius: BorderRadius.circular(20)),
        child: Text(badge, style: const TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w700)),
      ),
      const SizedBox(height: 10),
      Text(title, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: _ddTextDark)),
  ...
  Widget _nextBtn({String label = 'Next Set'}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: _ddBlue, borderRadius: BorderRadius.circular(12),
            boxShadow: const [BoxShadow(color: Color(0x334A90D9), blurRadius: 8, offset: Offset(0, 4))]),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          SizedBox(width: 7),
          Text('Games Menu', style: TextStyle(color: _ddBlue, fontWeight: FontWeight.w700, fontSize: 14)),
        ]),
      ),
    );
  }
  ...
  Widget _buildSet1() {
    ...
    return Stack(children: [
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        _setHeader('Set 1 of 3', 'Sequence the Study Steps', 'Drag cards into the correct order'),
        ...
        Container(
          ...
          child: Row(children: [
            Icon(Icons.info_outline_rounded, size: 14, color: attemptsLeft > 0 ? _ddAmber : _ddRed),
            ...
            Expanded(child: Text(
              ...
              style: TextStyle(fontSize: 11,
                  ...
                  fontWeight: _seqAttempts > 0 ? FontWeight.w700 : FontWeight.w400),
            )),
          ]),
        ),
        ...
        ...List.generate(5, (i) {
          ...
          final correct = _seqChecked && placed != null ? placed == _correctSeq[i] : null;
          return DragTarget<String>(
            ...
            builder: (ctx, cands, _) {
              ...
              return Container(
                ...
                height: 52,
                decoration: BoxDecoration(
                  color: correct == true ? _ddGreenLight : correct == false ? _ddRedLight
                      : hover ? _ddBlueLight : const Color(0xFFF8FAFC),
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(
                    color: correct == true ? _ddGreen : correct == false ? _ddRed
                        : hover ? _ddBlue : _ddDivider,
                    width: 1.5,
                  ),
                ),
                child: Row(children: [
                  Container(width: 40, alignment: Alignment.center,
                      child: Text('${i + 1}', style: const TextStyle(fontWeight: FontWeight.w700, color: _ddTextMid))),
                  Expanded(
                      child: placed != null
                          ? Row(children: [
                              Expanded(child: Draggable<String>(
                                data: placed,
                                feedback: Material(
                                  color: Colors.transparent,
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 10),
                                    decoration: BoxDecoration(color: _ddBlue, borderRadius: BorderRadius.circular(10)),
                                    child: Text(placed, style: const TextStyle(fontSize: 13, color: Colors.white, fontWeight: FontWeight.w700)),
                                  ),
                                ),
                                childWhenDragging: const SizedBox(),
                                child: Text(placed, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: _ddTextDark)),
                              )),
                              if (correct != null)
                                Icon(correct ? Icons.check_circle_rounded : Icons.cancel_rounded,
                                    color: correct ? _ddGreen : _ddRed, size: 20),
                              const SizedBox(width: 8),
                            ])
                          : const Text('Drop here...', style: TextStyle(color: Color(0xFFAAAAAA)))),
                ]),
              );
            },
          );
        ...
        if (remaining.isNotEmpty) ...[
          const Text('Cards to place:',
              style: TextStyle(fontWeight: FontWeight.w700, color: _ddTextMid, fontSize: 13)),
          const SizedBox(height: 8),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  boxShadow: const [BoxShadow(color: Color(0x334A90D9), blurRadius: 8, offset: Offset(0, 4))]),
              child: Text(
                _seqAttempts == 0 ? 'Check Sequence' : 'Submit Again (${attemptsLeft} left)',
            ...
            child: Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: const [BoxShadow(color: Color(0x4DD94040), blurRadius: 30, offset: Offset(0, 8))],
                ),
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  const Text('Review Needed!',
                      textAlign: TextAlign.center,
                      style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: _ddRed)),
                  const SizedBox(height: 10),
                  const Text(
                    'You used both attempts. Please review the lesson on case-control study steps before continuing.',
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 13, color: _ddTextMid, height: 1.5),
                  ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(color: _ddRed, borderRadius: BorderRadius.circular(12)),
                      child: const Text('Review Lessons', textAlign: TextAlign.center,
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: const Text('Restart This Set', textAlign: TextAlign.center,
                          style: TextStyle(color: _ddBlue, fontWeight: FontWeight.w700, fontSize: 15)),
                    ),
                  ),
                ]),
              ),
  ...
  Widget _buildSet2() {
    final remaining = _shuffledSourceKeys.where((k) => _sourcePlaced[k] == null).toList();
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      _setHeader('Set 2 of 3', 'Identify Sources', 'Drag each source to the correct bucket'),
      const SizedBox(height: 8),
      Container(
        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
        decoration: BoxDecoration(color: _ddAmberLight, borderRadius: BorderRadius.circular(8)),
        child: const Row(children: [
          Icon(Icons.info_outline_rounded, size: 14, color: _ddAmber),
          SizedBox(width: 6),
          Expanded(child: Text('Wrong placements are rejected — card returns to the pool.',
              style: TextStyle(fontSize: 11, color: _ddTextMid))),
        ]),
      ),
      const SizedBox(height: 12),
      Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Expanded(child: _bucket2('cases', 'CASES', const Color(0xFF1565C0), _ddBlueLight)),
        const SizedBox(width: 10),
        Expanded(child: _bucket2('controls', 'CONTROLS', const Color(0xFF1565C0), _ddBlueLight)),
      ]),
      const SizedBox(height: 16),
      const Text('Sources to place:', style: TextStyle(fontWeight: FontWeight.w700, color: _ddTextMid, fontSize: 13)),
      const SizedBox(height: 8),
      Wrap(children: remaining.map(_card).toList()),
      const SizedBox(height: 16),
  ...
  Widget _bucket2(String bucket, String label, Color color, Color bgColor) {
    final placed = _sourcePlaced.entries.where((e) => e.value == bucket).map((e) => e.key).toList();
    return DragTarget<String>(
      ...
      builder: (ctx, cands, rejected) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            color: wrongHover ? _ddRedLight : hover ? _ddGreenLight : bgColor,
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
                color: wrongHover ? _ddRed : hover ? _ddGreen : const Color(0xFFBDD5EE),
                width: wrongHover || hover ? 2 : 1.5),
          ),
          child: Column(children: [
            Text(label, style: TextStyle(fontWeight: FontWeight.w800, color: color, fontSize: 13)),
            const SizedBox(height: 8),
            if (placed.isEmpty)
              Container(height: 40, alignment: Alignment.center,
                  child: Text(wrongHover ? '✗ Wrong bucket!' : 'Drop here',
                      style: TextStyle(
                          ...
                          fontSize: 12, fontWeight: wrongHover ? FontWeight.w700 : FontWeight.w400)))
            else
              ...placed.map((c) => Container(
                    margin: const EdgeInsets.only(bottom: 4), padding: const EdgeInsets.all(8),
                    decoration: BoxDecoration(
                      color: _ddGreenLight, borderRadius: BorderRadius.circular(8),
                      border: Border.all(color: _ddGreen),
                    ),
                    child: Row(children: [
                      Expanded(child: Text(c, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600))),
                      const Icon(Icons.check_circle_rounded, color: _ddGreen, size: 16),
                    ]),
                  )),
          ]),
        );
  ...
  Widget _buildSet3() {
    final biasTypes = [
      'Recall bias', 'Berksonian bias', 'Interviewer bias',
      'Telescoping', 'Confounding', 'Prevalence-incidence bias',
    ];
    final remaining = _shuffledBiasKeys.where((k) => _biasPlaced[k] == null).toList();
    final wrongsLeft = 3 - _biasWrongDrops;

    return Stack(children: [
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        _setHeader('Set 3 of 3', 'Types of Bias', 'Drag each statement to the correct bias type'),
        const SizedBox(height: 8),
        Container(
          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
          decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8)),
          child: Row(children: [
            Icon(Icons.info_outline_rounded, size: 14, color: _biasWrongDrops > 0 ? _ddRed : _ddAmber),
            const SizedBox(width: 6),
            Expanded(child: Text(
              _biasWrongDrops == 0
              ...
              style: TextStyle(
                  ...
                  fontWeight: _biasWrongDrops > 0 ? FontWeight.w700 : FontWeight.w400),
            )),
          ]),
        ),
        const SizedBox(height: 12),
        ...
        const SizedBox(height: 16),
        const Text('Statements to place:', style: TextStyle(fontWeight: FontWeight.w700, color: _ddTextMid, fontSize: 13)),
        const SizedBox(height: 8),
        Wrap(children: remaining.map(_card).toList()),
        const SizedBox(height: 16),
        if (_bias3Done) ...[_nextBtn(label: 'Finish!'), const SizedBox(height: 10)],
        _gamesMenuBtn(),
      ]),
  ...
  Widget _biasBucket(String bias) {
    final placed = _biasPlaced.entries.where((e) => e.value == bias).map((e) => e.key).toList();
    return DragTarget<String>(
      ...
      builder: (ctx, cands, _) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(10),
            border: Border.all(color: hover ? _ddBlue : const Color(0xFFD8DBFF), width: 1.5),
          ),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(bias, style: const TextStyle(fontWeight: FontWeight.w800, color: _ddBlue, fontSize: 13)),
            if (placed.isEmpty)
              const Padding(padding: EdgeInsets.only(top: 4),
                  child: Text('Drop here...', style: TextStyle(color: Color(0xFFAAAAAA), fontSize: 12)))
            else
              ...placed.map((c) => Container(
                    ...
                    child: Row(children: [
                      Expanded(child: Text(c, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w500))),
                      const Icon(Icons.check_circle_rounded, color: _ddGreen, size: 16),
                    ]),
                  )),
          ]),
    ...
    return SingleChildScrollView(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Image.network(
          ...
          errorBuilder: (_, __, ___) => const Icon(Icons.emoji_events_rounded, size: 80, color: _ddBlue),
        ),
        const SizedBox(height: 20),
        ...
        const SizedBox(height: 8),
        const Text('Drag & Drop Complete!', style: TextStyle(fontSize: 14, color: _ddTextMid)),
        const SizedBox(height: 20),
        Container(
          ...
          child: Column(children: [
            ...
            const SizedBox(height: 4),
            Text('$pct%', style: TextStyle(fontSize: 48, fontWeight: FontWeight.w900,
                color: passed ? _ddBlue : const Color(0xFFE65100))),
            Text(passed ? 'You passed! ($_ddPass% required)' : 'You need $_ddPass% to proceed',
                style: TextStyle(fontSize: 12, color: passed ? _ddBlue : const Color(0xFFE65100))),
          ]),
        ),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(
                    color: passed ? const Color(0x4D4A90D9) : const Color(0x4DE65100),
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      child: Container(
        ...
        child: Column(children: [
          Container(
            width: double.infinity, padding: const EdgeInsets.fromLTRB(20, 16, 16, 16),
            color: _ddBlue,
          ...
          Container(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text('Set ${_gameWon ? 3 : _currentSet + 1} of 3',
                  style: const TextStyle(color: _ddBlue, fontWeight: FontWeight.w700, fontSize: 13)),
              Container(
